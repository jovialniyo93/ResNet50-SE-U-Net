...
from resnet50_se_net import build_resnet50_se_net 
from metrics import dice_coef,iou, f1_score, jacard_coef
...
if __name__ == "__main__":
    ...
    lr = 1e-4   ## 0.0001
    num_epochs = 10
    model_path = "files/resnet50_se_net.h5"
    ...
    metrics = ['accuracy',dice_coef,iou, f1_score, jaccard_score, Recall(), Precision()]
